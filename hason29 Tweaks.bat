...
call :WOTTitle
echo.
echo.                                          Installing Some Dependencies For WOT To Run Properly...
echo.
cd %tmp%
::Begin Log
...
echo.              
echo.              
echo.                                %b%[ %w%7 %b%] %w% Game Settings                %b%[ %w%8 %b%] %w% Program Installation 
echo.
echo.                            
echo.                                   
echo.                                    
...
Regedit /e "%SystemDrive%\hason29Tweaks\Reverts\RegistryBackup.reg"
...
bcdedit /export "%SystemDrive%\hason29Tweaks\Reverts\bcdbackup.bcd" 
)
cls
call :WOTTitle
echo. 
